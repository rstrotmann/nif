...
test_that("ae_summary handles invalid inputs", {
  ...
  expect_error(ae_summary(test_sdtm, level = "INVALID"),
               "Invalid level\\(s\\): INVALID")

  # Test with non-SDTM object
  expect_error(ae_summary(data.frame()),
...
test_that("ae_summary validates SDTM object structure", {
  ...
  expect_error(ae_summary(test_sdtm),
  ...
  test_sdtm <- new_sdtm(list(ae = test_ae))
  expect_error(ae_summary(test_sdtm, group = "INVALID_COL"),
  ...
  test_sdtm <- new_sdtm(list(ae = test_ae))
  expect_error(ae_summary(test_sdtm, show_cd = TRUE),
  ...
  test_sdtm <- new_sdtm(list(ae = test_ae))
  expect_error(ae_summary(test_sdtm, ae_filter = "invalid syntax"),
