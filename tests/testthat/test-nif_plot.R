...
test_that("plot.nif" , {
  ...
  expect_no_error(
    plot.nif(examplinib_sad_nif, log = T, mean = T, points = T,
              admin = "RS2023"))
  ...
  expect_no_error(
    plot(examplinib_sad_nif, mean = F, points = T, dose_norm = F,
              facet = "RACE", log = T, max_time = 72))

  expect_no_error(
    plot(examplinib_fe_nif, points = T, color = c("FASTED"), log = T,
              mean = T, max_time = 12, admin = "RS2023"))

  expect_no_error(
    plot(examplinib_fe_nif, points = T, facet = "FASTED", color = "SEX",
  ...
  expect_no_error(
    plot(examplinib_poc_nif, points = T, dose_norm = T, facet = NULL,
  ...
  expect_no_error(
    plot(examplinib_poc_nif, points = T, dose_norm = T, facet = "ANALYTE",
