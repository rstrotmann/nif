...
test_that("formula_to_mapping fails if first analyte is not PK", {
  f <- LACT + ANALYTE1 ~ DRUG1
  ...
  expect_error(
    formula_to_mapping(test_sdtm_formula_to_mapping(), f),
    "The first analyte"
  )
})
