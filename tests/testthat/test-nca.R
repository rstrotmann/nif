...
test_that("nca() time handling", {
  ...
  test_nif <- structure(
    tibble::tribble(
      ~ID, ~TIME, ~NTIME, ~DV,  ~EVID, ~ANALYTE, ~DOSE, ~AMT, ~CMT,
      1,   0,     0,      0,   1,     "DRUG",   100,   100,  1,
      1,   1,     1.1,    10,  0,     "DRUG",   100,   0,    2,
      1,   2,     2.2,    5,   0,     "DRUG",   100,   0,    2,
      1,   3,     3.3,    2,   0,     "DRUG",   100,   0,    2,
      2,   0,     0,      0,   1,     "DRUG",   100,   100,  1,
      2,   1,     1.1,    12,  0,     "DRUG",   100,   0,    2,
      2,   2,     2.2,    6,   0,     "DRUG",   100,   0,    2,
      2,   3,     3.3,    3,   0,     "DRUG",   100,   0,    2,
      3,   0,     0,      0,   1,     "DRUG",   100,   100,  1,
      3,   1,     1.1,    8,   0,     "DRUG",   100,   0,    2,
      3,   2,     2.2,    4,   0,     "DRUG",   100,   0,    2,
      3,   3,     3.3,    1,   0,     "DRUG",   100,   0,    2
    ),
    class = c("nif", "data.frame")
  )
...
test_that("nca() duplicate handling", {
  ...
  test_nif <- structure(
    tibble::tribble(
      ~ID, ~TIME, ~DV,  ~EVID, ~ANALYTE, ~DOSE, ~AMT, ~CMT,
      1,   0,     0,    1,     "DRUG",   100,   100,  1,
      1,   1,     10,   0,     "DRUG",   100,   0,    2,
      1,   1,     11,   0,     "DRUG",   100,   0,    2,
      1,   2,     5,    0,     "DRUG",   100,   0,    2,
      1,   2,     6,    0,     "DRUG",   100,   0,    2,
      1,   3,     2,    0,     "DRUG",   100,   0,    2,
      2,   0,     0,    1,     "DRUG",   100,   100,  1,
      2,   1,     12,   0,     "DRUG",   100,   0,    2,
      2,   1,     13,   0,     "DRUG",   100,   0,    2,
      2,   2,     6,    0,     "DRUG",   100,   0,    2,
      2,   2,     7,    0,     "DRUG",   100,   0,    2,
      2,   3,     3,    0,     "DRUG",   100,   0,    2
    ),
    class = c("nif", "data.frame")
  )
