test_that("make_plot_data_set handles basic functionality", {
  ...
  test_nif <- tibble::tribble(
    ~ID, ~ANALYTE, ~PARENT, ~EVID, ~DOSE, ~TIME, ~NTIME, ~TAFD, ~TAD, ~DV, ~DVCFB, ~CMT,
    1, "RS2023", "RS2023", 1, 100, 0, 0, 0, 0, NA, NA, 1,
    1, "RS2023", "RS2023", 0, 100, 1, 1, 1, 1, 10, 10, 1,
    1, "RS2023", "RS2023", 0, 100, 2, 2, 2, 2, 20, 20, 1,
    2, "RS2023", "RS2023", 1, 200, 0, 0, 0, 0, NA, NA, 1,
    2, "RS2023", "RS2023", 0, 200, 1, 1, 1, 1, 15, 15, 1,
    2, "RS2023", "RS2023", 0, 200, 2, 2, 2, 2, 25, 25, 1
  ) %>% as_nif()
...
test_that("make_plot_data_set handles color and facet parameters", {
  test_nif <- tibble::tribble(
    ~ID, ~ANALYTE, ~PARENT, ~EVID, ~DOSE, ~TIME, ~NTIME, ~TAFD, ~TAD, ~DV, ~DVCFB, ~RACE, ~SEX, ~CMT,
    1, "RS2023", "RS2023", 1, 100, 0, 0, 0, 0, NA, NA, "White", "M", 1,
    1, "RS2023", "RS2023", 0, 100, 1, 1, 1, 1, 10, 10, "White", "M", 1,
    1, "RS2023", "RS2023", 0, 100, 2, 2, 2, 2, 20, 20, "White", "M", 1,
    2, "RS2023", "RS2023", 1, 200, 0, 0, 0, 0, NA, NA, "Asian", "F", 1,
    2, "RS2023", "RS2023", 0, 200, 1, 1, 1, 1, 15, 15, "Asian", "F", 1,
    2, "RS2023", "RS2023", 0, 200, 2, 2, 2, 2, 25, 25, "Asian", "F", 1
  ) %>% as_nif()
...
test_that("make_plot_data_set handles cfb and dose_norm parameters", {
  test_nif <- tibble::tribble(
    ~ID, ~ANALYTE, ~PARENT, ~EVID, ~DOSE, ~TIME, ~NTIME, ~TAFD, ~TAD, ~DV, ~DVCFB, ~CMT,
    1, "RS2023", "RS2023", 1, 100, 0, 0, 0, 0, NA, NA, 1,
    1, "RS2023", "RS2023", 0, 100, 1, 1, 1, 1, 10, 5, 1,
    1, "RS2023", "RS2023", 0, 100, 2, 2, 2, 2, 20, 15, 1
  ) %>% as_nif()
...
test_that("make_plot_data_set handles min_time and max_time parameters", {
  test_nif <- tibble::tribble(
    ...
    1, "RS2023", "RS2023", 0, 100, 1, 1, 1, 1, 10, 10, 1,
    1, "RS2023", "RS2023", 0, 100, 2, 2, 2, 2, 20, 20, 1,
    1, "RS2023", "RS2023", 0, 100, 3, 3, 3, 3, 30, 30, 1
  ) %>% as_nif()
...
test_that("make_plot_data_set handles multiple analytes", {
  test_nif <- tibble::tribble(
    ...
    1, "RS2023", "RS2023", 1, 100, 0, 0, 0, 0, NA, NA, 1,
    1, "RS2023", "RS2023", 0, 100, 1, 1, 1, 1, 10, 10, 1,
    1, "M1", "RS2023", 0, 100, 1, 1, 1, 1, 5, 5, 2,
    1, "M2", "RS2023", 0, 100, 1, 1, 1, 1, 3, 3, 3
  ) %>% as_nif()
