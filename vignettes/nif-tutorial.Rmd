...
This is a basic tutorial on using the `nif` package to create NONMEM Input Format
...
As we will see in [NIF DATA SETS][NIF DATA SETS], nif objects are built sequentially from the
SDTM data set. Based on the actual data disposition, the `suggest()` function
provide useful code snippets for the creation of analysis data sets:
